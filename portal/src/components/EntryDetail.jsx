        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ padding: '6px 16px', borderBottom: '1px solid #2a2d35', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#161822', flexWrap: 'wrap', gap: 4 }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              ...
              {topicHTML && (
                <button onClick={() => {
                  const exportCSS = `body, body > div, body > section, body > article, body > main, [class*="container"], [class*="wrapper"], [class*="content"] { max-width: 100% !important; width: 100% !important; margin-left: 0 !important; margin-right: 0 !important; padding-left: 20px !important; padding-right: 20px !important; } @media print { body { padding: 20px !important; background: #fff !important; color: #222 !important; } [style*="color: #e0e0e0"], [style*="color: #ccc"], [style*="color: #ddd"], [style*="color: #eee"], [style*="color: #fff"], [style*="color: rgb(224"], [style*="color: rgb(255"] { color: #222 !important; } [style*="background: #0f"], [style*="background: #1"], [style*="background: #2"], [style*="background-color: #0f"], [style*="background-color: #1"], [style*="background-color: #2"], [style*="background: rgb(1"], [style*="background: rgb(2"] { background: #f5f5f5 !important; } * { max-width: 100% !important; overflow: visible !important; height: auto !important; max-height: none !important; -webkit-text-fill-color: initial !important; -webkit-background-clip: initial !important; background-clip: initial !important; } h1,h2,h3,h4,h5,h6 { page-break-after: avoid; color: #111 !important; } pre, code { background: #f5f5f5 !important; } pre, blockquote, table { page-break-inside: avoid; border-color: #ccc !important; } img { max-width: 100% !important; } a { color: #1a73e8 !important; } }`;
