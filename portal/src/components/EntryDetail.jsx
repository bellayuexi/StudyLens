        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ padding: '6px 16px', borderBottom: '1px solid #2a2d35', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#161822', flexWrap: 'wrap', gap: 4 }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              ...
              {topicHTML && (
                <button onClick={() => {
                  const printCSS = `body, body > div, body > section, body > article, body > main, [class*="container"], [class*="wrapper"], [class*="content"] { max-width: 100% !important; width: 100% !important; margin-left: 0 !important; margin-right: 0 !important; padding-left: 20px !important; padding-right: 20px !important; } @media print { *, *::before, *::after { color: #000 !important; text-shadow: none !important; box-shadow: none !important; border-color: #ccc !important; } body, div, section, article, main, span, p, li, td, th, blockquote, pre, header, footer, nav, details, summary { background: #fff !important; background-color: #fff !important; background-image: none !important; } div, section, article, main, [class*="container"], [class*="wrapper"], [class*="content"] { max-width: 100% !important; width: 100% !important; margin-left: 0 !important; margin-right: 0 !important; overflow: visible !important; height: auto !important; max-height: none !important; } a { text-decoration: underline; } img { max-width: 100% !important; } h1,h2,h3,h4,h5,h6 { page-break-after: avoid; } pre, blockquote, table { page-break-inside: avoid; border: 1px solid #ccc !important; } pre, code { background: #f5f5f5 !important; } }`;
